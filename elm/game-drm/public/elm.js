...
var $author$project$Main$InitArea = function (a) {
	return {$: 'InitArea', a: a};
};
...
var $author$project$Main$Pill = function (a) {
	return {$: 'Pill', a: a};
};
...
var $author$project$Main$setToArea = F3(
	function (a, _v0, area) {
		var x = _v0.a;
		var y = _v0.b;
		return A3(
			...
			y,
			A2($elm$core$Array$set, x, a),
			area);
	});
var $author$project$Main$initArea = A3(
	$author$project$Main$setToArea,
	$author$project$Main$Pill($author$project$Main$Red),
	_Utils_Tuple2(5, 0),
	A3(
		$author$project$Main$setToArea,
		$author$project$Main$Pill($author$project$Main$Red),
		...
		A2(
			...
			16,
			A2($elm$core$Array$repeat, 8, $author$project$Main$Empty))));
...
var $author$project$Main$Virus = function (a) {
	return {$: 'Virus', a: a};
};
...
var $author$project$Main$randomPill = A2(
	$elm$random$Random$uniform,
	$author$project$Main$Empty,
	_List_fromArray(
		[
			$author$project$Main$Virus($author$project$Main$Red)
		]));
var $author$project$Main$randomArea = function () {
	var randomRow = A2(
		$elm$random$Random$map,
		$elm$core$Array$fromList,
		A2($elm$random$Random$list, 8, $author$project$Main$randomPill));
	var maxHeight = 8;
	var randomRows = A2(
		$elm$random$Random$map,
		$elm$core$Array$fromList,
		A2($elm$random$Random$list, maxHeight, randomRow));
	return A2(
		$elm$random$Random$map,
		function (rows) {
			return A2(
...
var $author$project$Main$pillToColur = function (pill) {
	switch (pill.$) {
		case 'Empty':
...
var $author$project$Main$pos4InArray = function (array) {
	return function (_v2) {
		var pos = _v2.c;
		return pos;
	}(
		A3(
			...
			F2(
				function (cell, _v0) {
					...
					var pos = _v0.c;
					return (!_Utils_eq(pos, $elm$core$Maybe$Nothing)) ? _Utils_Tuple3(
						colour,
						_Utils_Tuple2(count, currentPos + 1),
						pos) : (_Utils_eq(cell, colour) ? (((count + 1) === 4) ? _Utils_Tuple3(
						cell,
						_Utils_Tuple2(count + 1, currentPos + 1),
						$elm$core$Maybe$Just(currentPos - 3)) : _Utils_Tuple3(
						cell,
						_Utils_Tuple2(count + 1, currentPos + 1),
						$elm$core$Maybe$Nothing)) : _Utils_Tuple3(
						cell,
						_Utils_Tuple2(1, currentPos + 1),
						$elm$core$Maybe$Nothing));
				}),
			_Utils_Tuple3(
				...
				_Utils_Tuple2(0, 0),
				$elm$core$Maybe$Nothing),
			A2($elm$core$Array$map, $author$project$Main$pillToColur, array)));
};
var $author$project$Main$pos4InRow = F2(
	function (y, area) {
		return A2(
			$elm$core$Maybe$map,
			function (x) {
			...
			A2(
				...
				$author$project$Main$pos4InArray,
				A2($elm$core$Array$get, y, area)));
	});
var $author$project$Main$removeXRangeFromArea = F3(
	function (_v0, n, area) {
		var x = _v0.a;
		var y = _v0.b;
		return A3(
			...
			function (row) {
				return A3(
					...
					F2(
						function (n_, row_) {
							return A3($elm$core$Array$set, x + n_, $author$project$Main$Empty, row_);
						}),
					row,
...
var $author$project$Main$checkAreaFor4s = function (area) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (y, area_) {
				var pos = A2($author$project$Main$pos4InRow, y, area_);
				return _Utils_eq(pos, $elm$core$Maybe$Nothing) ? area_ : A2(
					...
					A2(
						...
						function (_v0) {
							...
							var y_ = _v0.b;
							return A3(
								$author$project$Main$removeXRangeFromArea,
								_Utils_Tuple2(x_, y_),
								4,
								area_);
						},
...
var $author$project$Main$getFromArea = F2(
	function (_v0, area) {
		var x = _v0.a;
		var y = _v0.b;
		return A2(
...
var $author$project$Main$hasInArea = F2(
	function (_v0, area) {
		var x = _v0.a;
		var y = _v0.b;
		return !_Utils_eq(
			$elm$core$Maybe$Just($author$project$Main$Empty),
			A2(
				$elm$core$Maybe$andThen,
				$elm$core$Array$get(x),
				A2($elm$core$Array$get, y, area)));
...
var $author$project$Main$removeFromArea = $author$project$Main$setToArea($author$project$Main$Empty);
var $author$project$Main$movePillDown = F3(
	function (_v0, _v1, area) {
		...
		var y1_ = y1 + 1;
		var mel2 = A2(
			$author$project$Main$getFromArea,
			_Utils_Tuple2(x2, y2),
			area);
		var mel1 = A2(
			$author$project$Main$getFromArea,
			...
			area);
		var canMove = (!A2(
			$author$project$Main$hasInArea,
			_Utils_Tuple2(x1, y1_),
			area)) && ((!A2(
			$author$project$Main$hasInArea,
			_Utils_Tuple2(x2, y2_),
			area)) && ((y1_ <= 15) && (y2_ <= 15)));
		return canMove ? _Utils_Tuple2(
			$elm$core$Maybe$Just(
				_Utils_Tuple2(
					_Utils_Tuple2(x1, y1_),
					_Utils_Tuple2(x2, y2_))),
			A2(
				...
				A3(
					...
					F2(
						function (el1, el2) {
							return $author$project$Main$checkAreaFor4s(
								A3(
									$author$project$Main$setToArea,
									el2,
									_Utils_Tuple2(x2, y2_),
									A3(
										...
										_Utils_Tuple2(x1, y1_),
										A2(
											$author$project$Main$removeFromArea,
											_Utils_Tuple2(x2, y2),
											A2(
												$author$project$Main$removeFromArea,
												_Utils_Tuple2(x1, y1),
					...
					mel1,
					mel2))) : _Utils_Tuple2($elm$core$Maybe$Nothing, area);
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'InitArea') {
			var area = msg.a;
			var a_ = A2($elm$core$Debug$log, 'init', area);
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						activePill: $elm$core$Maybe$Just(
							_Utils_Tuple2(
								_Utils_Tuple2(5, 0),
								_Utils_Tuple2(4, 0))),
						area: A3(
			...
			if (!A2(
				...
				50,
				$elm$core$Basics$floor(model.count))) {
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(model.activePill, model.area),
					A2(
						$elm$core$Maybe$map,
						function (_v2) {
							var pos1 = _v2.a;
							var pos2 = _v2.b;
							return A3($author$project$Main$movePillDown, pos1, pos2, model.area);
						},
						model.activePill));
				var activePill_ = _v1.a;
				var area_ = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{activePill: activePill_, area: area_, count: model.count + 1}),
					$elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Main$colourToColor = function (colour) {
	switch (colour.$) {
		case 'Blue':
...
var $author$project$Main$flattenArray = A2($elm$core$Array$foldl, $elm$core$Array$append, $elm$core$Array$empty);
...
var $author$project$Main$viewArea = F3(
	function (h, w, area) {
		var ySize = h / $elm$core$Array$length(area);
		return $elm$core$Array$toList(
			$author$project$Main$flattenArray(
				A2(
					$elm$core$Array$indexedMap,
					F2(
						function (indexY, row) {
							var xSize = w / $elm$core$Array$length(row);
							return A2(
								$elm$core$Array$indexedMap,
								F2(
									function (indexX, cell) {
										return A2(
											$joakin$elm_canvas$Canvas$shapes,
											_List_fromArray(
												[
													$joakin$elm_canvas$Canvas$Settings$fill(
													$author$project$Main$colourToColor(
														$author$project$Main$pillToColur(cell)))
												]),
											$elm$core$List$singleton(
												A3(
													$joakin$elm_canvas$Canvas$rect,
													_Utils_Tuple2(indexX * xSize, indexY * ySize),
													xSize - 10.0,
													ySize - 10.0)));
									}),
								row);
...
var $author$project$Main$render = F2(
	function (count, area) {
		...
		var x = -(size / 2);
		var y = -(size / 2);
		var iCount = $elm$core$Basics$floor(count);
		var currentC = $author$project$Main$Blue;
		return A3($author$project$Main$viewArea, $author$project$Main$width, $author$project$Main$height, area);
	});
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($author$project$Main$render, count / 25, area)))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				{activePill: $elm$core$Maybe$Nothing, area: $author$project$Main$initArea, count: 0},
				A2($elm$random$Random$generate, $author$project$Main$InitArea, $author$project$Main$randomArea));
		},
